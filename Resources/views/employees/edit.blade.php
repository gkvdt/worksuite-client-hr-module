        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-wrapper collapse in" aria-expanded="true">
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('client.employees.index') }}" class="btn btn-default">@lang('app.back')</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
<script>
    $("#joining_date, .date-picker,  #end_date").datepicker({
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('client.employees.update', [$userDetail->id])}}',
        ...
        $('#department-setting').on('click', function (event) {
            ...
            var url = '{{ route('client.teams.quick-create')}}';
        ...
        $('#designation-setting').on('click', function (event) {
            event.preventDefault();
            var url = '{{ route('client.designations.quick-create')}}';
            $('#modelHeading').html("@lang('messages.manageDepartment')");
            $.ajaxModal('#departmentModel', url);
        });
</script>
