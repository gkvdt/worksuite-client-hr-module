    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('client.employees.index') }}">{{ __($pageTitle) }}</a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @forelse($projects as $key=>$project)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td><a href="{{ route('client.projects.show', $project->id) }}">{{ ucwords($project->project_name) }}</a></td>
                        ...
                        <table class="table" style="margin-top: 10px;">
                            ...
                            @forelse($employeeDocs as $key=>$employeeDoc)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('client.employee-docs.download', $employeeDoc->id) }}"
...
<script>
    ...
    function showAdd() {
        var url = "{{ route('client.employees.docs-create', [$employee->id]) }}";
        $.ajaxModal('#edit-column-form', url);
    }

    $('#edit-leave-type').click(function () {
        var url = "{{ route('client.employees.leaveTypeEdit', [$employee->id]) }}";
        $.ajaxModal('#edit-column-form', url);
    })
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('client.employee-docs.destroy',':id') }}";
    ...
    function showTable() {
        ...
        var url = '{{ route('client.employees.tasks', [$employee->id, ':hideCompleted']) }}';
...
<script>
    ...
    function showTable2(){
        ...
        var url = '{{ route('client.employees.time-logs', [$employee->id]) }}';
