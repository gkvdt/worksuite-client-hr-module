...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('client.employees.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.employees.addNewEmployee') <i class="fa fa-plus" aria-hidden="true"></i></a>
            <ol class="breadcrumb">
        ...
        <div class="col-md-12 m-b-30">
            <div class="white-box">
                ...
                <div class="col-sm-6 text-center b-l">
                    <h4><span class="text-danger" id="free-employee">{{ $freeEmployees }}</span> <span class="font-12 text-muted m-l-5"><a href="{{ route('client.employees.freeEmployees') }}" > @lang('modules.dashboard.freeEmployees')</a></span></h4>
                </div>
...
<script>
    ...
    $(function() {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('client.employees.destroy',':id') }}";
        ...
        $('body').on('click', '.assign_role', function(){
            ...
            $.easyAjax({
                url: '{{route('client.employees.assignRole')}}',
                type: "POST",
