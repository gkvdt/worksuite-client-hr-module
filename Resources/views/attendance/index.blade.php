    ...
    <div class="row bg-title">
        ...
        <div class="col-sm-9 text-right">
            <div class="form-group">
                <a href="{{ route('client.attendances.create') }}"
    ...
    <div class="row">
        ...
        <div class="sttabs tabs-style-line col-md-12">
            <div class="white-box">
                <nav>
                    <ul>
                        <li><a href="{{ route('client.attendances.summary') }}"><span>@lang('app.summary')</span></a>

                        <li class="tab-current"><a href="{{ route('client.attendances.index') }}"><span>@lang('modules.attendance.attendanceByMember')</span></a>
                        </li>
                        <li><a href="{{ route('client.attendances.attendanceByDate') }}"><span>@lang('modules.attendance.attendanceByDate')</span></a>
                        </li>
...
<script>
    ...
    function showTable() {
        ...
        //refresh counts
        var url = '{!!  route('client.attendances.refreshCount', [':startDate', ':endDate', ':userId']) !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('client.attendances.employeeData', [':startDate', ':endDate', ':userId']) !!}';
    ...
    $('#attendanceData').on('click', '.delete-attendance', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('client.attendances.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function exportData(){
        ...
        var url = '{{ route('client.employees.export', [':status' ,':employee', ':role']) }}';
    ...
    function exportData(){
        ...
        var url = '{{ route('client.attendances.export', [':startDate' ,':endDate' ,':employee']) }}';
        url = url.replace(':startDate', startDate);
        url = url.replace(':endDate', endDate);
        url = url.replace(':employee', employee);
