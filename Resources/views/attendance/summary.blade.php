    ...
    <div class="row">
        ...
        <div class="sttabs tabs-style-line col-md-12">
            <div class="white-box">
                <nav>
                    <ul>
                        <li class="tab-current"><a href="{{ route('client.attendances.summary') }}"><span>@lang('app.summary')</span></a>
                        </li>
                        <li><a href="{{ route('client.attendances.index') }}"><span>@lang('modules.attendance.attendanceByMember')</span></a>
                        </li>
...
<script>
    ...
    function showTable() {
        ...
        //refresh counts
        var url = '{!!  route('client.attendances.summaryData') !!}';
    ...
    $('#attendance-data').on('click', '.view-attendance',function () {
        ...
        var url = '{!! route('client.attendances.info', ':attendanceID') !!}';
    ...
    $('#attendance-data').on('click', '.edit-attendance',function (event) {
        ...
        var url = '{!! route('client.attendances.mark', [':userid',':day',':month',':year',]) !!}';
    ...
    $('body').on('click', '.bulk-attendance',function (event) {
        var url = '{!! route('client.attendances.bulk') !!}';
        $('#modelHeading').html('{{__("app.menu.attendance") }}');
        $.ajaxModal('#projectTimerModal', url);
    });
    ...
    function editAttendance (id) {
        ...
        var url = '{!! route('client.attendances.edit', [':id']) !!}';
