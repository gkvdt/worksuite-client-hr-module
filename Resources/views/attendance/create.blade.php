    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('client.attendances.index') }}">{{ __($pageTitle) }}</a></li>
...
<script>
    ...
    function checkHoliday() {
        ...
        $.easyAjax({
            url: '{{route('client.attendances.check-holiday')}}',
            type: "GET",
            data: {
                date: selectedDate,
                _token: token
    ...
    function showTable(){
        table = $('#attendance-table').dataTable({
            ...
            bInfo: false,
            ajax: {
                url: "{!! route('client.attendances.data') !!}",
                data: function (d) {
                    console.log(d);
    ...
    function attendanceDetail(id,attendanceDate) {
        var url = "{{ route('client.attendances.detail') }}?userID="+id+"&date="+attendanceDate;
