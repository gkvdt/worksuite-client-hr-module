    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('client.attendances.index') }}">{{ __($pageTitle) }}</a></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
            ...
            <div class="white-box">
                <nav>
                    <ul>
                        ...
                        <li class="tab-current"><a href="{{ route('client.attendances.attendanceByDate') }}"><span>@lang('modules.attendance.attendanceByDate')</span></a>
                        </li>
    ...
    <script>
        ...
        function showTable(){
            table = $('#attendance-table').dataTable({
                ...
                searching: false,
                ajax: {
                    url: "{!! route('client.attendances.byDateData') !!}",
                    data: function (d) {
        ...
        $('#attendance-table').on('click', '.save-attendance', function () {
            ...
            $.easyAjax({
                url: '{{route('client.attendances.store')}}',
                type: "POST",
        ...
        function getAttendanceCount(date){
            $.easyAjax({
                url: '{{route('client.attendances.dateAttendanceCount')}}',
                type: "POST",
                data: {
                    date: date,
                    _token: '{{ csrf_token() }}'
