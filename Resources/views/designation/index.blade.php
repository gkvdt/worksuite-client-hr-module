...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('client.designations.create') }}" class="btn btn-outline btn-success btn-sm">@lang('app.add') @lang('app.menu.designation') <i class="fa fa-plus" aria-hidden="true"></i></a>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group dropdown m-r-10">
                                        ...
                                        <ul role="menu" class="dropdown-menu pull-right">
                                            <li><a href="{{ route('client.designations.edit', [$group->id]) }}"><i class="icon-settings"></i> @lang('app.manage')</a></li>
                                ...
                                <td colspan="3" class="text-center">
                                    <div class="empty-space" style="height: 200px;">
                                        <div class="empty-space-inner">
                                            ...
                                            <div class="subtitle">
                                                <a href="{{ route('client.designations.create') }}"
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('client.designations.destroy',':id') }}";
