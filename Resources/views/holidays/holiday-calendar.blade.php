    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('client.holidays.index') }}">@lang('app.menu.holiday')</a></li>
...
<script>
    ...
    var getEventDetail = function (id) {
        var url = '{{ route('client.holidays.show', ':id')}}';
...
<script>
    ...
    function showAdd() {
        var url = "{{ route('client.holidays.create') }}";
        $.ajaxModal('#eventDetailModal', url);
    }
    ...
    function setMonthData(d){
        ...
        var year = "{{ $year }}";
        var url = "{{ route('client.holidays.calendar-month') }}?startDate="+encodeURIComponent(firstDay)+"&year="+year;
    ...
    function getYearData(){
        var year = $('#year').val();
        var url = "{{ route('client.holidays.calendar', ':year') }}";
