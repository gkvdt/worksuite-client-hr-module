...
class ClientEmployeesDataTable extends BaseDataTable
{
    /**
    ...
    public function query(User $model)
    {
        ...
        if ($request->designation != 'all' && $request->designation != '') {
            $users = $users->where('client_employee_details.designation_id', $request->designation);
        }

        if ($request->department != 'all' && $request->department != '') {
            $users = $users->where('client_employee_details.department_id', $request->department);
        }
    ...
    protected function getColumns()
    {
        return [
            ...
            __('modules.employees.employeeId') => ['data' => 'employee_id', 'name' => 'client_employee_details.employee_id'],
