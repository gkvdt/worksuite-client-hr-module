 ...
 */
class ManageAttendanceController extends ClientBaseController
{
    ...
    public function index()
    {
        ...
        return view('hr::attendance.index', $this->data);
    }
    ...
    {
        return view('hr::attendance.create', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->type = 'edit';
        return view('hr::attendance.attendance_mark', $this->data);
    }
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($attendances)
            ->editColumn('id', function ($row) {
                return view('hr::attendance.attendance_list', ['row' => $row, 'global' => $this->global, 'maxAttandenceInDay' => $this->maxAttandenceInDay])->render();
            })
            ->rawColumns(['id'])
            ->removeColumn('name')
    ...
    public function employeeData(Request $request, $startDate = null, $endDate = null, $userId = null)
    {
        ...
        // Getting View data
        $view = view('hr::attendance.user_attendance', ['dateWiseData' => $dateWiseData, 'global' => $this->global])->render();
    ...
    {
        return view('hr::attendance.by_date', $this->data);
    }
    ...
    public function byDateData(Request $request)
    {
        ...
        return DataTables::of($attendances)
            ->editColumn('id', function ($row) {
                return view('hr::attendance.attendance_date_list', ['row' => $row, 'global' => $this->global])->render();
            })
            ->rawColumns(['id'])
            ->removeColumn('name')
            ->removeColumn('clock_in_time')
    ...
    public function attendanceDetail(Request $request)
    {
        ...
        return view('hr::attendance.attendance-detail', $this->data)->render();
    }
    ...
    public function bulkAttendanceStore(StoreBulkAttendance $request): array
    {
        ...
        return Reply::redirect(route('client.attendances.summary'), __('messages.attendanceSaveSuccess'));
    }
    ...
    public function bulkAttendance(Request $request)
    {
        ...
        return view('hr::attendance.bulk-attendance', $this->data)->render();
    }
    ...
    public function summary()
    {
        ...
        return view('hr::attendance.summary', $this->data);
    }
    ...
    public function summaryData(Request $request)
    {
        ...
        foreach ($employees as $employee) {
            ...
            $final[$employee->id . '#' . $employee->name][] = '<a class="userData" id="userID' . $employee->id . '" data-employee-id="' . $employee->id . '"  href="' . route('client.employees.show', $employee->id) . '">' . $image . ' ' . ucwords($employee->name) . '</a>';
        ...
        $view = view('hr::attendance.summary_data', $this->data)->render();
        return Reply::dataOnly(['status' => 'success', 'data' => $view]);
    }
    ...
    public function detail($id)
    {
        ...
        return view('hr::attendance.attendance_info', $this->data);
    }
