...
class ManageLeavesController extends ClientBaseController
{
    ...
    public function index()
    {
        ...
        $this->pendingLeaves = Leave::where('status', 'pending')
            ...
            ->get();
        return view('hr::leaves.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('hr::leaves.create', $this->data);
    }
    ...
    public function store(StoreLeave $request)
    {
        ...
        return Reply::redirect(route('hr::leaves.index'), __('messages.leaveAssignSuccess'));
    }
    ...
    public function show($id)
    {
        ...
        return view('hr::leaves.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->leaveTypes = LeaveType::all();
        $this->leave = Leave::findOrFail($id);
        $view = view('hr::leaves.edit', $this->data)->render();
    ...
    public function rejectModal(Request $request)
    {
        ...
        return view('hr::leaves.reject-reason-modal', $this->data);
    }
    ...
    public function allLeave()
    {
        ...
        return view('hr::leaves.all-leaves', $this->data);
    }
    ...
    public function pendingLeaves()
    {
        ...
        return view('hr::leaves.pending', $this->data);
    }
}
