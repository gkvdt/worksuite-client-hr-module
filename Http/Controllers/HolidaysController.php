...
class HolidaysController extends ClientBaseController
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(function ($request, $next) {
            if(!in_array('hr',$this->user->modules)){
                abort(403);
            }
            return $next($request);
        });
    ...
    public function index(IndexRequest $request)
    {
        ...
        return View::make('hr::holidays.index', $this->data);
    }
    ...
    public function viewHoliday($year)
    {
        ...
        $view = View::make('hr::holidays.holiday-view', $this->data)->render();
    ...
    {
        return View::make('hr::holidays.create', $this->data);
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        return Reply::redirect(route('hr::holidays.index'), __('messages.holidayAddedSuccess'));
    }
    ...
    public function show($id)
    {
        ...
        return view('hr::holidays.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('hr::holidays.edit', compact('holiday'));
    }
    ...
    {
        Holiday::destroy($id);
        return Reply::redirect(route('hr::holidays.index'), __('messages.holidayDeletedSuccess'));
    }
    ...
    public function holidayCalendar($year = null){
        ...
        return view('hr::holidays.holiday-calendar', $this->data);
    }
    ...
    public function getCalendarMonth(Request $request){
        ...
        $view = view('hr::holidays.month-wise-holiday', $this->data)->render();
    ...
    public function markHoliday(Request $request)
    {
        ...
        return View::make('hr::holidays.mark-holiday', $this->data);
    }
    ...
    public function markDayHoliday(CommonRequest $request){
        ...
        return Reply::redirect(route('hr::holidays.index'), '<strong>All Sundays</strong> successfully added to the Database');
    }
