...
use Modules\Hr\Entities\ClientTeam as Team;

class ManageTeamsController extends ClientBaseController
{
    ...
    public function index()
    {
        ...
        return view('hr::teams.index', $this->data);
    }
    ...
    {
        return view('hr::teams.create', $this->data);
    }
    ...
    public function store(StoreTeam $request)
    {
        ...
        return Reply::redirect(route('client.teams.index'), 'Group created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hr::teams.edit', $this->data);
    }
    ...
    public function update(StoreTeam $request, $id)
    {
        ...
        return Reply::redirect(route('client.teams.index'), __('messages.groupUpdatedSuccessfully'));
    }
    ...
    {
        $this->teams = Team::all();
        return view('hr::teams.quick-create', $this->data);
    }
    /**
