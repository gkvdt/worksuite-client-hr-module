...
use Modules\Hr\Entities\ClientDesignation as Designation;
...
class ManageDesignationController extends ClientBaseController
{
    ...
    public function index()
    {
        ...
        return view('hr::designation.index', $this->data);
    }
    ...
    {
        return view('hr::designation.create', $this->data);
    }
    ...
    public function quickCreate()
    {
        ...
        return view('hr::designation.quick-create', $this->data);
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return Reply::redirect(route('client.designations.index'), 'Designation created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hr::designation.edit', $this->data);
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Reply::redirect(route('client.designations.index'), __('messages.updatedSuccessfully'));
    }
